...
//  Table SV
	...
	try {
		...
		("SELECT * FROM table_lop");
		while(result.next())
		{
			arrMH.add(new QuanLyModelLopHoc(result.getString("MaLop")
					,result.getString("MoTa"),result.getString("NamHoc")));
		}
		} catch (Exception e) {
		e.printStackTrace();
		}
