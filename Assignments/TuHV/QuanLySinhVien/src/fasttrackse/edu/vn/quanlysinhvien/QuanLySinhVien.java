...
public class QuanLySinhVien {
		...
		public static void inDSSV() {
			...
			for (i = 0; i < SinhVien.tongSV; i++) {
				...
				System.out.printf("%-5s%-23s%-14s%-5s%-5s%-5s\n", (i + 1), arrSV.get(i).getSVten(), arrSV.get(i).getSVngaysinh(),arrSV.get(i).getSVLP1(),arrSV.get(i).getSVLP2(),arrSV.get(i).getSVDTB());
			}
			myScanner.nextLine();
			System.out.println("Ấn Enter để về menu chính");
			myScanner.nextLine();
		...
		public static void topSV() {
			...
			System.out.printf("%-23s%-14s%-5s%-5s%-5s\n", arrSV.get(y).getSVten(),arrSV.get(y).getSVngaysinh(),arrSV.get(y).getSVLP1(),arrSV.get(y).getSVLP2(),arrSV.get(y).getSVDTB());

			System.out.println("Học sinh có kết quả học tập thấp nhất là :");
			System.out.printf("%-23s%-14s%-5s%-5s%-5s\n", arrSV.get(x).getSVten(),arrSV.get(x).getSVngaysinh(),arrSV.get(x).getSVLP1(),arrSV.get(x).getSVLP2(),arrSV.get(x).getSVDTB());
			myScanner.nextLine();
			System.out.println("Ấn Enter để về menu chính");
			myScanner.nextLine();
		...
		public static void sapxepTBM() {
			...
			for (i = 0; i < n; i++) {
				...
				System.out.println("--------------------------------------------------------------------");
				for (i = 0; i < n; i++) {
					System.out.printf("%-5s%-23s%-14s%-5s%-5s%-5s%-10s\n", (i + 1), arrSV.get(i).getSVten(),arrSV.get(i).getSVngaysinh(),arrSV.get(i).getSVLP1(),arrSV.get(i).getSVLP2(),arrSV.get(i).getSVDTB(),arrSV.get(i).getSVxeploai());
				}
			}
