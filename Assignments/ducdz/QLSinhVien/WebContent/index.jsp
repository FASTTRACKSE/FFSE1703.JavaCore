...
<body>
	<div align="center">
		...
		<h3>
			<a href="/QLSinhVien/SVL_main/*">Back Home</a>
		</h3>
		<table>
			<tr>
				<th>Mã Sinh Viên</th>
			...
			<c:forEach var="listSV" items="${sv}">
				<tr>
					...
					<td><a href="/QLSinhVien/SVL_main/edit?sid=${listSV.id}">Edit</a><a
						href="/QLSinhVien/SVL_main/delete?sid=${listSV.id}">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
		<h4>
			<%
				...
				for (int i = 1; i <= trang; i++) {
					out.print("<a href='/QLSinhVien/SVL_main/pagination?pid=" + i + "'>" + i + ' ' + "</a>");
				}
			%>
		</h4>
	</div>
