...
public class QuanLiSinhVien {
	...
	public static void themSv() {
			...
			File file = new File("D:/FFSE1703.JavaCore/Assignments/TuanNM/assignment8/dulieusinhvientext.txt");	    
		    if(file.exists()) {
			...
			boolean kt = TextFileFactory.luuFile(arrSinhVien, "dulieusinhvientext.txt");
			if (kt == true) {
