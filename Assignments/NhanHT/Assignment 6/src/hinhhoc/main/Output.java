	...
	public static void Indanhsach() {
		for (HinhHoc x : arrHinhHoc) {
			if (x instanceof HinhTron) {
				System.out.println("Hinh Tron    ||" + "Dien Tich la: " + x.getDienTich() + "||Chu Vi la: "
						+ x.getChuVi() + " ||Ban Kinh: " + ((HinhTron) x).getBanKinh());
			} else if (x instanceof HinhChuNhat) {
				System.out.println("Hinh Chu Nhat||" + "Dien Tich la: " + x.getDienTich() + "||Chu Vi la: "
						+ x.getChuVi() + "||Chieu Dai: " + ((HinhChuNhat) x).getChieuDai() + "||Chieu Rong: "
						+ ((HinhChuNhat) x).getChieuRong());
			} else if (x instanceof HinhTamGiac) {
				System.out.println("Hinh Tam Giac||" + "Dien Tich la: " + x.getDienTich() + "||Chu Vi la: "
						+ x.getChuVi() + "||CanhA: " + ((HinhTamGiac) x).getCanhA() + "||CanhB: "
						+ ((HinhTamGiac) x).getCanhB() + "||CanhC: " + ((HinhTamGiac) x).getCanhC());
			} else if (x instanceof HinhVuong) {
				System.out.println("Hinh Vuong   ||" + "Dien Tich la: " + x.getDienTich() + "||Chu Vi la: "
						+ x.getChuVi() + "||Canh: " + ((HinhVuong) x).getCanh());
			}
		}
	}
