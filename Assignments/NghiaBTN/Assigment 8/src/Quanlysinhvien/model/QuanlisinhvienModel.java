...
public class QuanlisinhvienModel implements Serializable {
	...
	public QuanlisinhvienModel(String name, String day, double Lp1, double Lp2) {
		this.Name = name;
		this.Date = day;
		this.Lp1 = Lp1;
		this.Lp2 = Lp2;
	...
	public String toString() {
		return this.Name+"  "+this.Date+"  "+this.Lp1+"  "+this.Lp2;
	}
