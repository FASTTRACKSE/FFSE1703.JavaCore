...
//		for (; stt < arrKhachHang.size(); stt++) {};
		...
		for(KhachHang x : arrKhachHang) {
			...
			arrBienLai.add(new BienLai(x.getMaKhachHang(), x.getTenKhachHang(), x.getDiaChi(), x.getMaCongTo(), chiSoCu, chiSoMoi, thang, nam));
	...
	public void inKhachHang() {
		...
		System.out.printf("| %-3s | | %-15s | | %-20s | | %-20s | | %-20s | \n", "STT",
				"Mã khách hàng", "Tên khách hàng", "Địa chỉ", "mã công tơ");
	...
	public void meNuInBienLai() {
		while(true) {
			...
			System.out.println("3. In biên lai theo tháng.");
			System.out.println("4. In theo năm.");
	...
	public void inBienLaiFull() {
		...
		System.out.printf("| %-3s | | %-15s | | %-20s | | %-20s | | %-15s | | %-15s | | %-15s | | %-15s | | %-10s | \n", "STT",
				"Mã khách hàng", "Tên khách hàng", "Địa chỉ", "Chỉ số cũ", "Chỉ số mới", "Tháng", "Năm", "Thành tiền");
		int i = 1;
			...
			for (BienLai x : arrBienLai) {
				...
				System.out.printf("| %-3s | | %-15s | | %-20s | | %-20s | | %-15s | | %-15s | | %-15s | | %-15s | | %-10s | \n", i,
						x.getMaKhachHang(), x.getTenKhachHang(),
						x.getDiaChi(), x.getChiSoCu(), x.getChiSoMoi(),
