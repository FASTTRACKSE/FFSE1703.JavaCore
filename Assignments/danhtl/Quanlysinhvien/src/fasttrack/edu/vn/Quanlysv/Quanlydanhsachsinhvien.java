...
public class Quanlydanhsachsinhvien {
    ...
    public static ArrayList<bangsv> arrbangsv = new ArrayList<bangsv>();
	public static int i, n = 4;
	public static bangsv[] SV = new bangsv[4];

	public static void main(String[] args) {
		bangsv Sv1 = new bangsv("Hồ Quang Minh", "30/10/99", 8.0, 6.0);
		bangsv Sv2 = new bangsv("Lê Phước Hiếu", "13/05/99", 9.0, 6.0);
		bangsv Sv3 = new bangsv("Nguyễn Thanh Hiếu", "26/09/99", 4.0, 5.0);
		bangsv Sv4 = new bangsv("Hồ Việt Tú", "04/04/99", 6.0, 4.0);
		SV[0] = Sv1;
		SV[1] = Sv2;
		SV[2] = Sv3;
		SV[3] = Sv4;
	...
	public static void nhapDSSV() {
		...
		try {
			...
			for (i = 0; i < n; i++) {	
				...
				arrbangsv.add(new bangsv(Name,Date,Lp1, Lp2 ));
				bangsv.tongsv();
			}
			}
        catch (Exception e) {
	...
	public static void inDSSV() {
		System.out.println("tổng số sv là:"+bangsv.tongsv);

		System.out.println("Danh sách sinh viên ");
		System.out.println("--------------------------------------------------------------------");
		System.out.println("STT  Họ và tên              Ngày sinh     lp1  lp2  ĐTB  ");
		System.out.println("--------------------------------------------------------------------");
		for (i = 0; i <bangsv.tongsv; i++) {

			System.out.printf("%-5s%-23s%-14s%-5s%-5s%-5s\n", (i + 1), arrbangsv.get(i).getName(), arrbangsv.get(i).getDate(), arrbangsv.get(i).getLp1(),
					arrbangsv.get(i).getLp2(), arrbangsv.get(i).getTBM());
		}
		myScanner.nextLine();
		System.out.println("Ấn Enter để về menu chính");
		myScanner.nextLine();
